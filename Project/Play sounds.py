...
def read_text():
    ...
    if text:
        # Create an instance of gTTS with the text and language
...
# Background image
background_image = PhotoImage(file="D:\\Project\\background_image.png") # choose desried path
...
# Read Button
read_btn = Button(root, text='Read', font='Georgia 10 bold', pady=5, command=read_text, bg='white', activebackground='white smoke')
read_btn.place(x=495, y=280)
